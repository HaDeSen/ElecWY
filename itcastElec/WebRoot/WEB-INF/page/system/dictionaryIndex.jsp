		...
		if (document.Form1.keyword.value == "jerrynew") {
			...
			Pub
					.submitActionWithForm(
							'Form2',
							'${pageContext.request.contextPath }/system/dictionaryEdit.jsp',
							'Form1');
			...
			<TBODY>
				<tr>
					<td class="ta_01" colspan=3 align="center"
						...
						<font face="宋体" size="2"><strong>数据字典维护</strong>
					</font></td>
				</tr>
				<TR height=10>
					<td colspan=3></td>
				...
				<tr>
					...
					<s:select
							list="#request.list" name="keyword" listKey="keyword"
							listValue="keyword" headerKey="jerrynew" headerValue=""
...
<!-- 						<select name="keyword" class="bg" style="width:180px" onchange="changetype()">
						<option value="jerrynew"></option>
						 <s:iterator value="#request.list">
						 	<option value="keyword"><s:property value="keyword"/></option>
						 </s:iterator>	
						 <s:iterator value="#request.list" var="system">
						 	<option value="#system.keyword"><s:property value="#system.keyword"/></option>
						 </s:iterator>						
						</select> --></td>
