          ...
          <td width="84%" colspan="4">      
           <table border="0" width="100%" cellspacing="0" cellpadding="0">
               <tr>
                  ...
                  <s:select list="#request.nomap" name="colname1" id="colname1" multiple="true" style="width:200px" ondblclick="JavaScript:Add('colname1','colname2','colname')"></s:select>
                   </td> 
                   <td width="15%"></td>
                   <td width="35%" rowspan="4" id="colnameDiv">
                   
                   <s:select list="#request.map" name="colname2" id="colname2" multiple="true" style="width:200px" ondblclick="JavaScript:Remove('colname1','colname2','colname')"></s:select>
                   </td>  
                  ...
                  <tr><td width="73">
                  		<s:hidden name="belongTo" id="belongTo"  value="5-3" ></s:hidden>
                  		<s:hidden name="expNameList" id="expNameList"  value="" ></s:hidden>
                  		<s:hidden name="expFieldName" id="expFieldName"  value="" ></s:hidden>
                  		<s:hidden name="noExpNameList" id="noExpNameList"  value="" ></s:hidden>
                  		<s:hidden name="noExpFieldName" id="noExpFieldName"  value="" ></s:hidden>
                  </td></tr>     
           </table>  
          </td>
        </tr>
